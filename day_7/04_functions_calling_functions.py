# ---------------------------------------------------------
# DAY 7 | TOPIC 4: FUNCTIONS CALLING FUNCTIONS 🔧
...
show_report("Alice", [92, 88, 95, 90])
show_report("Bob",   [65, 72, 58, 70])
...
# calculate_average and get_grade are completely reusable.
...
print(f"Class grade:   {get_grade(avg)}")
...
def temperature_report(city, celsius):
    ...
    print(f"{city}: {celsius}degC = {fahrenheit:.1f}degF = {kelvin:.2f}K")
