...
print("\nPrice: Rs.", price)
print("Body temperature:", body_temp, "degC")
...
print(f"Final score after +=, -=, *= : {score}")

# Real example — a running total
total = 0
total += 120  # total = 120
total += 350  # total = 470
print(f"Running total: Rs. {total}")


# 5. REAL-WORLD MATH EXAMPLE
print("\n--- Shopping Receipt ---")
item_price = 250
quantity = 4
discount = 50
