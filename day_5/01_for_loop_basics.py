# ---------------------------------------------------------
# DAY 5 | TOPIC 1: THE FOR LOOP — From Scratch 🔄
...
# ─────────────────────────────────────────────────────────
# SECTION 6: LOOP + IF — THE POWER COMBO
# ─────────────────────────────────────────────────────────
# Combining a loop with an if statement is the most common
# pattern in all of Python!
...
# ─────────────────────────────────────────────────────────
# SECTION 7: LOOPING OVER A STRING
# ─────────────────────────────────────────────────────────
# A string is just a sequence of characters — Python can loop
# over it one letter at a time!
