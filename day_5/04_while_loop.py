# ---------------------------------------------------------
# DAY 5 | TOPIC 4: THE WHILE LOOP — Keep Going Until... 🔁
...
while tries < max_attempts:
    ...
    print("Account locked after 3 failed attempts! (locked)")
...
# ─────────────────────────────────────────────────────────
# SECTION 5: FLAG VARIABLE WITH ERROR HANDLING
# ─────────────────────────────────────────────────────────
# In real programs, you often need to handle bad input too.

print("\n--- Mini calculator with error checking ---")
running = True
