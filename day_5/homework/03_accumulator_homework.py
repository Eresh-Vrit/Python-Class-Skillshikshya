...
# ⭐ BONUS CHALLENGE:
# Create a variable word = "python"
# Use an accumulator to build the reversed word.
# Print: "Original: python | Reversed: nohtyp"
# Hint: start with reversed_word = "" and add each letter to the FRONT.
# Write your code below:
