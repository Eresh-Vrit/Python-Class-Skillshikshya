# ---------------------------------------------------------
# DAY 6 | TOPIC 1: WHAT IS A FUNCTION? 🧩
...
# Here's the full anatomy with a parameter and docstring (from the slides):
# def greet_user(name):
#     """Greet someone by name."""       ← docstring (optional but recommended)
#     print(f"Hello, {name}!")           ← function body (indented 4 spaces)
#
